...
const RECS: {
...
}[] = [
  {
    ...
    translations: {
      ...
      ca: 'Haniel és una persona extremadament determinada que sempre apunta al cim. Vaig tenir el plaer de seguir de prop el desenvolupament dels seus projectes, i les seves habilitats de lideratge i qualitat tècnica són definitivament notables. És un excel·lent professional!',
    },
  },
  {
    id: 2,
    ...
    translations: {
      ...
      ca: 'Vaig conèixer Haniel a través de la comunitat Google Developers Aracaju quan em vaig convertir en voluntària. Les seves principals habilitats inclouen la comunicació, el lideratge i la iniciativa. Durant el temps que hem treballat junts, he tingut l\'oportunitat d\'observar de prop com Hani és una persona que excel·leix en el treball en equip, contribuint al creixement dels seus companys i traient el millor de les persones alineant les seves habilitats amb les necessitats de la comunitat. Un agraïment especial per tot el que he après de tu i per inspirar tantes persones a marcar la diferència amb el coneixement que han adquirit. Veritablement generes un impacte allà on vas.',
    },
  },
  {
    id: 3,
    ...
    translations: {
      ...
      ca: 'Vaig tenir l\'oportunitat de treballar amb Haniel al GDG Aracaju, i puc dir que és una de les persones més compromeses i inspiradores amb qui he col·laborat. Es distingeix pel seu lideratge, iniciativa i excepcionals habilitats de comunicació. Cada vegada que sorgeix un repte, estava al capdavant, trobant les millors solucions per garantir que els esdeveniments de GDG fossin sempre un èxit.',
    },
  },
  {
    id: 4,
    ...
    translations: {
      ...
      ca: 'Vaig tenir l\'oportunitat de treballar amb Haniel Rolemberg en diversos projectes i puc dir amb confiança que és excepcional — tant en habilitats tècniques com en el tracte amb les persones. Haniel va jugar un paper crucial en la gestió de projectes innovadors, mantenint sempre el focus en els resultats i assegurant que els equips estiguessin alineats i motivats. Té una capacitat única per identificar els punts forts de cada projecte i maximitzar els resultats. Recomano àmpliament Haniel per a qualsevol repte que requereixi lideratge, innovació i excel·lència tècnica.',
    },
  },
]
